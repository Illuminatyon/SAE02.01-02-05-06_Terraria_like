...
public class GlobalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        hitboxView = new HitboxView(hitboxManager, entitiesPane);
    ...
    private void initPlayer() {
        ...
        // Ajouts d'exemples d'items dans l'inventaire
        ...
        // Gestionnaire clavier et souris
    ...
    private void initAggressiveMob(Player player) {
        AggressiveMob aggressiveMob = new AggressiveMob(
                0, 0, 40, 54, tileMap, 5, 1, 15, 10, ActorEnum.ZOMBIE, player, 20, 1500, aliveActors, entitiesPane, 1, this.hitboxManager
        );
